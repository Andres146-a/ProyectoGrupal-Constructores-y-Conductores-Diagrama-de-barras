...
public class DriverBarChartWindow extends Application {

    private BarChart<String, Number> barChart;
    private boolean ascendingOrder = false;  // Default to descending order
    private ObservableList<DriverResult> resultsList;
    ...
    public void start(Stage primaryStage) {
        primaryStage.setTitle("Barra de Conductores");
        ...
        xAxis.setLabel("Nombre del Conductor");
        ...
        barChart.setTitle("Puntos Totales por Conductor");
    ...
    private void updateResults(int year) {
        DriverResultsController controller = new DriverResultsController(null);
    ...
    private void sortResults() {
        if (resultsList != null) {
            ...
            SortedList<DriverResult> sortedData = new SortedList<>(resultsList, comparator);

            XYChart.Series<String, Number> series = new XYChart.Series<>();
            series.setName("Puntos Totales");

            for (DriverResult result : sortedData) {
